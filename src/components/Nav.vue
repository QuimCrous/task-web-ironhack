    ...
    >
      ...
      >
        <router-link to="/" class="flex items-center">
          <img src="/Icono.png" class="h-6 mr-3 sm:h-9" alt="Done Logo" />
          <img
            src="/Icono_letras.png"
        ...
        >
          ...
          >
            ...
            <li>
              <p
                class="block py-2 pl-3 pr-4 text-gray-700 rounded md:border-0 md:p-0 dark:text-gray-400"
              >
                Welcome, {{ userEmail }}
              </p>
            </li>
